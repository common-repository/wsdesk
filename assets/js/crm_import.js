jQuery(function () {
    ...
    jQuery(".nav-pills").on("click", "a", function (e) {
        ...
        {
            case 'zendesk_import':
                jQuery('#breadcrump_section').html("From Zendesk");
                break;
        }
    });
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                else
                {
                    ...
                    jQuery("#danger_alert_text").html("<strong>Zendesk Import</strong><br>"+parse.data+"!");
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                ...
                jQuery(".alert-danger").css("display", "block");
                jQuery(".alert-danger").css("opacity", "1");
                jQuery("#danger_alert_text").html("<strong>Zendesk Import</strong><br>"+errorThrown+"!");
                window.setTimeout(function () {
                    jQuery(".alert-danger").fadeTo(500, 0).slideUp(500, function () {
                        jQuery(this).css("display", "none");
                    });
            ...
            success: function (data) {
                ...
                switch(parse.status)
                {
                    case "failure":
                        ...
                        jQuery(".alert-danger").css("display", "block");
                        jQuery(".alert-danger").css("opacity", "1");
                        jQuery("#danger_alert_text").html("<strong>Zendesk Import</strong><br>"+parse.body+"!");
                        break;
                    case "continue":
                    ...
                    case "completed":
                        ...
                        jQuery("#success_alert_text").html("<strong>Zendesk Import</strong><br>"+parse.total+" Tickets Import Successful!");
                        break;
                }
            },
            error: function (jqXHR, textStatus, errorThrown) {
                ...
                jQuery(".alert-danger").css("display", "block");
                jQuery(".alert-danger").css("opacity", "1");
                jQuery("#danger_alert_text").html("<strong>Zendesk Import</strong><br>Something Went Wrong!");
            }
        });
    }
    jQuery("#zendesk_import_tab").on("click", "#stop_pull_tickets", function (e) {
        ...
        jQuery(".alert-danger").css("display", "block");
        jQuery(".alert-danger").css("opacity", "1");
        jQuery("#danger_alert_text").html("<strong>Zendesk Import</strong><br>Import Stopped Manually!");
    });
});