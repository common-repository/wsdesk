...
jQuery(function () {
    ...
    jQuery("#add_agents_tab").on("change", "#add_agents_role", function (e) {
        ...
        var supervisor_check = '<span id="add_agents_rights_supervisor">\
                                <input type="checkbox" style="margin-top: 0;" class="form-control" name="add_agents_rights" id="add_agents_rights_templates" value="templates"> Manage Templates<br>\
                                <input type="checkbox" style="margin-top: 0;" class="form-control" name="add_agents_rights" id="add_agents_rights_settings" value="settings"> Show Settings Page<br>\
                                <input type="checkbox" style="margin-top: 0;" class="form-control" name="add_agents_rights" id="add_agents_rights_agents" value="agents"> Show Agents Page<br>\
                                <input type="checkbox" style="margin-top: 0;" class="form-control" name="add_agents_rights" id="add_agents_rights_email" value="email"> Show Email Page<br>\
                                <input type="checkbox" style="margin-top: 0;" class="form-control" name="add_agents_rights" id="add_agents_rights_import" value="import"> Show Import Page<br>\
                                <input type="checkbox" style="margin-top: 0;" class="form-control" name="add_agents_rights" disabled> Merge Tickets<span class="wsdesk_super">Premium</span><br>\
                                </span>';
