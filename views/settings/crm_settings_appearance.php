...
if(!$submit_ticket_button) $submit_ticket_button = __('Submit Request', 'wsdesk');
if(!$reset_ticket_button) $reset_ticket_button = __('Reset Request', 'wsdesk');
if(!$existing_ticket_button) $existing_ticket_button = __('Check your Existing Request', 'wsdesk');
...
<div class="crm-form-element">
    <div class="col-md-8">
        ...
        <input type="text" class="form-control" id="main_ticket_form_title" value="<?php echo $main_ticket_form_title; ?>" placeholder="Contact Support">
    </div>
</div>                          
<div class="crm-form-element">
    <div class="col-md-8">
