...
?>
    <div style="text-align: center;">
        ...
        <p>
        <?php _e('IMAP is not enabled on your server. Please contact your service provider.','wsdesk'); ?>
        <br>
        <span class="crm-divider"></span>
        <b><?php _e('Have a Google account?','wsdesk'); ?></b> <?php _e('Use WSDesk Google OAuth setup.','wsdesk'); ?>
        <br>
...
<!--<center>-->
    ...
    <div class="crm-form-element">
        <div class="col-md-12">
            ...
            <input type="checkbox" id="delete_email" autocomplete="off" value="yes" disabled class="form-control"><label style="font-weight: normal;">Enable <span class="wsdesk_super"><?php _e('Premium','wsdesk'); ?></span></label>
        </div>
    </div>
    <div class="crm-form-element">
        <div class="col-md-12">
