...
class WSDesk_Setup_Wizard {
	...
	public function wsdesk_setup_wizard() {
		...
		if ( ! empty( $_POST['save_step'] ) && isset( $this->steps[ $this->step ]['handler'] ) ) {
			call_user_func( $this->steps[ $this->step ]['handler'], $this );
                ...
                wp_register_script("jquery-2.2.4.min", EH_CRM_MAIN_JS . "welcome/jquery-2.2.4.min.js");
                ...
                <body style="background-color:#f1f1f1 !important;">
                    <center>
                        <div class="logo" style="margin-bottom:20px;">
                            <a href="https://wsdesk.com" target="_blank">
	...
	public function setup_wizard_footer() {
            ?>
                    ...
                    <?php wp_print_scripts( 'jquery-2.2.4.min' ); ?>
                    <?php wp_print_scripts( 'bootstrap' ); ?>
                    <?php wp_print_scripts( 'dialog' ); ?>
                    <?php wp_print_scripts( 'jquery.bootstrap' ); ?>
                    <?php wp_print_scripts( 'material-bootstrap-wizard' ); ?>
                    <?php wp_print_scripts( 'jquery.validate.min' ); ?>
                    <?php wp_print_scripts( 'crm_settings' ); ?>
                    <?php wp_print_scripts( 'crm_agents' ); ?>
                    <?php wp_print_scripts( 'select2' ); ?>
                    <?php wp_print_scripts( 'crm_email' ); ?>
                    <?php wp_print_scripts( 'dragDrop' ); ?>
                    </body>
            </html>
            <?php
	}
		...
		?>
                <center>
                    <div style="margin-top:10px;">
                        <form method="post">
                            <p style="margin: 0 0 15px;"><?php printf( __( 'Set your support page title and email ID.', 'wsdesk' ), esc_url( admin_url( 'edit.php?post_type=page' ) ) ); ?></p>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-sm-4">
	...
	public function wsdesk_setup_pages_save() {
            ...
            $name = ($_POST['page_name'] !== "")?sanitize_text_field($_POST['page_name']):"Support";
	...
	public function wsdesk_setup_ready() {
            ...
            {
                ?>
                <div class="alert alert-info" role="alert"><strong><?php _e('Have a WooCommerce Store? Upgrade to', 'wsdesk'); ?> <a href="https://wsdesk.com" class="alert-link" target="_blank">WSDesk Premium</a> for store-based support.</strong></div>
                <?php 
            }
            ...
            <div class="row" style="margin:20px 0px;">
                <div class="col-sm-12" style="background-color:#f5f5f5;padding: 10px;">
                    ...
                    <div class="col-sm-6">
                        <ul>
                            <li style="font-size:15px;margin-bottom: 10px;"><span class="glyphicon glyphicon-link"></span> <a style="cursor:pointer;" href="https://wsdesk.com/documentation/" target="_blank"><?php esc_html_e( 'WSDesk Documentation', 'wsdesk' ); ?></a></li>
            ...
            <div style="background-color:#f5f5f5;padding: 10px;">
                <center><h2 style="margin-top:15px;"><?php _e('Premium WSDesk Features','wsdesk'); ?></h2></center>
                    <span class="crm-divider"></span>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-6">
                                <div class="video_content" style="display:flex;">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/4ORavx5hRqQ" frameborder="0" allowfullscreen></iframe>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            <div style="display:block;padding-left: 30px;text-align: left;">
                                <ul class="premium-ul">
                                    <li>
                                        <span class="dashicons dashicons-tag"></span>
                                        <span  class="premium-li"><?php _e('Auto Tagging And Assigning', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-search"></span>
                                        <span  class="premium-li"><?php _e('Auto Suggestion System', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-list-view"></span>
                                        <span  class="premium-li"><?php _e('Ticket Custom Views', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-megaphone"></span>
                                        <span  class="premium-li"><?php _e('Triggers & Automation', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-welcome-learn-more"></span>
                                        <span  class="premium-li"><?php _e('Customer Feedback Survey', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-awards"></span>
                                        <span  class="premium-li"><?php _e('Agent\'s Satisfaction Rating', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-admin-plugins"></span>
                                        <span  class="premium-li"><?php _e('WooCommerce Fields & Reports', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-update"></span>
                                        <span  class="premium-li"><?php _e('WSDesk Backup & Restore', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-clipboard"></span>
                                        <span  class="premium-li"><?php _e('One Year Support & Updates', 'wsdesk'); ?></span>
                                    </li>
                                    <li>
                                        <span class="dashicons dashicons-smiley"></span>
                                        <span  class="premium-li"><?php _e('Many more on its way', 'wsdesk'); ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <center>
                            <p style=" margin: 0 0 10px;">
                                <?php _e('Do you want to get all the features or want to see the demo?', 'wsdesk'); ?><br>
                                <a class="btn btn-primary" href="https://wsdesk.com" target="_blank"><?php _e('Start over with Pro Version', 'wsdesk'); ?></a>
                                <a class="btn btn-info" href="http://livedemo.wsdesk.com/wp-admin/admin.php?page=wsdesk_settings" target="_blank"><?php _e('See Live Demo of Pro Version', 'wsdesk'); ?></a>
                            </p>
                        </center>
                    </div>
                </div>
