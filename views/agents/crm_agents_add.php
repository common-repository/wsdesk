...
<div class="crm-form-element">
    <div class="col-md-3">
        <label for="add_agents_select" style="padding-right:1em !important;"><?php _e('Add Users', 'wsdesk'); ?></label>
    </div>
    <div class="col-md-9">
...
<div class="crm-form-element">
    <div class="col-md-3">
        <label for="add_agents_role" style="padding-right:1em !important;"><?php _e('WSDesk Role', 'wsdesk'); ?></label>
    </div>
    <div class="col-md-9">
        <span class="help-block"><?php _e('Roles for the selected users', 'wsdesk'); ?></span>
        <span style="vertical-align: middle;">
            <input type="radio" style="margin-top: 0;" class="form-control" id="add_agents_role" name="add_agents_role" value="agents" checked> <?php _e('WSDesk Agents', 'wsdesk'); ?><br>
            <input type="radio" style="margin-top: 0;" class="form-control" id="add_agents_role" name="add_agents_role" value="supervisor"> <?php _e('WSDesk Supervisor', 'wsdesk'); ?><br>
        </span>
    </div>
</div>
<div class="crm-form-element">
    <div class="col-md-3">
        <label for="add_agents_rights" style="padding-right:1em !important;"><?php _e('WSDesk Rights', 'wsdesk'); ?></label>
    </div>
    <div class="col-md-9">
        ...
        <span style="vertical-align: middle;" id="add_agents_access_rights">
            ...
            <input type="checkbox" style="margin-top: 0;" class="form-control" name="add_agents_rights" id="add_agents_rights_delete" value="delete"> <?php _e('Delete Tickets', 'wsdesk'); ?><br>
            <input type="checkbox" style="margin-top: 0;" class="form-control" name="add_agents_rights" id="add_agents_rights_manage" value="manage"> <?php _e('Manage Tickets', 'wsdesk'); ?><br>
        </span>
    </div>
</div>
<div class="crm-form-element">
